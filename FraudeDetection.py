...
F1B(Recall_logist,pre_logist,2)
F1B(Recall_KNN,pre_KNN,2)
F1B(Recall_RF,pre_RF,2)
F1B(Recall_Xgboost,pre_Xgboost,2)
...
#F1_Score
ar = np.array([['RegressionLogistic',0.6667861772249649],['RandomForest',0.6712188555965284],['K neighbors',0.5662515614737738],['Xgboost',0.6704281354128749]])
